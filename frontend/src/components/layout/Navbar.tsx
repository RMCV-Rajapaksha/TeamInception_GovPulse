...
// import QRScanner from "../qr/QRScanner"; // Module not found, commented out
...
export default function Navbar() {
  ...
  // const [isQrScanOpen, setIsQrScanOpen] = React.useState(false); // QRScanner not used
  ...
  },
  {
    ...
    date: "2 Aug 2025 — 9:45 AM"
      ...
      {/* QRScanner component is commented out because the module was not found. */}
      {/*
      <QRScanner
        isOpen={isQrScanOpen}
