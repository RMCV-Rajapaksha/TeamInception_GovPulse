...
} = require("../../middleware/processClerkToken");
...
router.post(
  "/cancel-appointment-by-official",
  verifyOfficialToken,
  cancelAppointment
);
router.post(
  "/add-attendee-by-user",
  clerkMiddleware(),
  addUserIdFromClerk,
  addRelatedUserFromDatabase,
  addAttendeeToAppointment
...
router.post(
  "/add-attendee-by-official",
  verifyOfficialToken,
  addAttendeeToAppointment
);
router.get(
  "/attendees-of-appointment/:appointment_id",
  getAttendeesOfAppointment
);
router.delete(
  "/remove-attendee-from-appointment-by-user/:attendee_id",
  clerkMiddleware(),
  addUserIdFromClerk,
  addRelatedUserFromDatabase,
  removeAttendeeFromAppointment
...
router.delete(
  "/remove-attendee-from-appointment-by-official/:attendee_id",
  verifyOfficialToken,
  removeAttendeeFromAppointment
);
router.post(
...
router.get(
  "/get-attachment-for-appointment/:appointment_id",
  getAttachmentByAppointmentId
);
router.post(
...
router.post("/send-official-update", verifyOfficialToken, sendOfficialUpdate);
router.post(
