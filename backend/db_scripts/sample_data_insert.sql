...
((SELECT "user_id" FROM "USER" WHERE "email" = 'amal.perera@email.com'), 'Pothole on Main Street', 'A large pothole has formed on the main street, causing traffic issues and risk to vehicles.', 'Colombo', 'Colombo North', 'Colombo Central', 8.5, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Pending Review' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Road Development Authority')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Road Development Authority'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Road Infrastructure'), '["https://www.sundaytimes.lk/151101/uploads/Col-2-300x225.jpg"]', TRUE),
...
((SELECT "user_id" FROM "USER" WHERE "email" = 'kasun.b@email.com'), 'Garbage not collected for weeks', 'The street garbage bins are overflowing. This is a major health hazard.', 'Galle', 'Galle East', 'Akmeemana', 7.8, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Received' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'National Solid Waste Management Center')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'National Solid Waste Management Center'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Waste Management'), '["https://bmkltsly13vb.compat.objectstorage.ap-mumbai-1.oraclecloud.com/cdn.ft.lk/ftadmin/wp-content/files_mf/14931377936952468002.jpg"]', FALSE),
((SELECT "user_id" FROM "USER" WHERE "email" = 'lakshmi.g@email.com'), 'Street light broken', 'A street light near the school has been broken for over a month, making the area unsafe at night.', 'Gampaha', 'Gampaha North', 'Gampaha', 6.5, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Pending Review' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Urban Development Authority')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Urban Development Authority'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Urban Development'), '["https://c.ndtvimg.com/2022-03/768mbqbg_sri-lanka-power-cutsri-lanka-economic-crisis-afp-650_625x300_31_March_22.jpg"]', FALSE),
...
((SELECT "user_id" FROM "USER" WHERE "email" = 'saman.w@email.com'), 'Corrupt official at local police station', 'I want to report an instance of an official demanding a bribe. I have evidence.', 'Nuwara Eliya', 'Nuwara Eliya Central', 'Nuwara Eliya', 9.9, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Under Investigation' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Sri Lanka Police')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Sri Lanka Police'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Public Safety'), '["https://courtofappeal.lk/?melsta_doc_download=1&doc_id=dce072ea-05e1-44d2-80c1-31b83339a94c&filename=HCC-206-208-19.pdf.pdf"]', TRUE),
((SELECT "user_id" FROM "USER" WHERE "email" = 'priya.k@email.com'), 'Wild elephant threat in village', 'A wild elephant has been seen regularly near our village, causing damage to crops and properties.', 'Trincomalee', 'Trincomalee East', 'Kinniya', 9.5, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Pending Review' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Department of Wildlife Conservation')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Department of Wildlife Conservation'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Environment & Wildlife'), '["https://www.youtube.com/watch?v=On2MBFcf4_g"]', TRUE),
((SELECT "user_id" FROM "USER" WHERE "email" = 'dilani.j@email.com'), 'Expired food at local store', 'A local food store is selling expired food products. This is a public health concern.', 'Anuradhapura', 'Anuradhapura North', 'Anuradhapura', 9.0, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Scheduled for Inspection' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Ministry of Health')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Ministry of Health'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Public Health'), '["https://www.sundaytimes.lk/130714/uploads/expired-goods.jpg"]', TRUE),
...
((SELECT "user_id" FROM "USER" WHERE "email" = 'anusha.s@email.com'), 'Crop disease affecting paddy fields', 'A new disease is affecting our paddy crops, and we need expert advice and help.', 'Matara', 'Matara North', 'Akuressa', 8.2, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Pending Review' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Ministry of Agriculture')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Ministry of Agriculture'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Agriculture'), '["https://doa.gov.lk/wp-content/uploads/2020/06/RRDI_BrownSpot5.jpg"]', TRUE),
((SELECT "user_id" FROM "USER" WHERE "email" = 'amal.perera@email.com'), 'Damaged drainage system', 'The drainage system on our road is blocked, causing flooding during rain.', 'Colombo', 'Colombo South', 'Dehiwala', 7.5, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Assigned to Team' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Road Development Authority')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Road Development Authority'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Road Infrastructure'), '["https://bmkltsly13vb.compat.objectstorage.ap-mumbai-1.oraclecloud.com/cdn.dailymirror.lk/assets/uploads/image_556620614a.jpg"]', FALSE),
...
((SELECT "user_id" FROM "USER" WHERE "email" = 'amal.perera@email.com'), 'Fallen tree on road', 'A large tree has fallen and is blocking a major road, causing a traffic jam.', 'Colombo', 'Colombo South', 'Homagama', 9.0, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Pending Review' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Road Development Authority')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Road Development Authority'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Road Infrastructure'), '["https://adaderanaenglish.s3.amazonaws.com/1613754220road3.jpg"]', FALSE),
((SELECT "user_id" FROM "USER" WHERE "email" = 'kasun.b@email.com'), 'Improper waste disposal in public park', 'There are large piles of garbage in the public park, attracting stray animals.', 'Galle', 'Galle Central', 'Habaraduwa', 8.1, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Received' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'National Solid Waste Management Center')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'National Solid Waste Management Center'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Waste Management'), '["https://www.researchgate.net/profile/Hannah-White-61/publication/370204829/figure/fig1/AS:11431281153270087@1682407233025/Stray-dog-rummaging-through-disposable-diaper-waste-on-an-open-dump-site-in-Ndirande.png"]', TRUE),
...
((SELECT "user_id" FROM "USER" WHERE "email" = 'jayantha.r@email.com'), 'Lack of irrigation for paddy fields', 'Our paddy fields are suffering due to a lack of proper irrigation. The water channels are damaged.', 'Jaffna', 'Jaffna North', 'Thenmarachchi', 8.8, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Pending Review' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Ministry of Agriculture')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Ministry of Agriculture'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Agriculture'), '["https://www.aljazeera.com/wp-content/uploads/2023/08/2023-08-29T060853Z_2120679309_RC2IR2AO8LP5_RTRMADP_3_SRI-LANKA-CRISIS-DROUGHT-1693374849.jpg"]', TRUE),
((SELECT "user_id" FROM "USER" WHERE "email" = 'anusha.s@email.com'), 'Damaged pedestrian bridge', 'The pedestrian bridge over the railway line is severely damaged and unsafe to use.', 'Matara', 'Matara South', 'Dickwella', 9.5, (SELECT "status_id" FROM "ISSUE_STATUS" WHERE "status_name" = 'Pending Review' AND "authority_id" = (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Road Development Authority')), (SELECT "authority_id" FROM "AUTHORITIES" WHERE "name" = 'Road Development Authority'), (SELECT "category_id" FROM "CATEGORIES" WHERE "category_name" = 'Road Infrastructure'), '["https://www.sundaytimes.lk/250330/uploads/nnn.jpg"]', TRUE);
...
((SELECT "appointment_id" FROM "APPOINTMENT" WHERE "official_comment" = 'The issue has been reviewed, and an appointment for an inspection is scheduled.'), ARRAY['https://www.mohsl.gov.lk/en/img/projects/ongoing/15627392643.jpg', 'http://govpulse.lk/file/report_summary.pdf']),
