...
-- 8. Insert sample data into ATTENDEES
-- The junction table has been removed, so attendees are now inserted with a direct foreign key to APPOINTMENT.
INSERT INTO "ATTENDEES" ("nic", "name", "phone_no", "appointment_id") VALUES
('334455667V', 'Michael Brown', '0771234567', (SELECT "appointment_id" FROM "APPOINTMENT" WHERE "date" = '2025-08-15')),
('667788990V', 'Emily White', '0719876543', (SELECT "appointment_id" FROM "APPOINTMENT" WHERE "date" = '2025-08-15'));
